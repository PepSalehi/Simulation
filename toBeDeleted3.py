# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 16:56:08 2017
...
#==============================================================================
    ...
    #        t = t - (60*60)
        ...
        e_ = time.time()
        if e_ - s_ > 0.2:
            print "central station update chunck ", e_ - s_
        s_ = time.time()
        # Victoria  
        ...
        e_ = time.time()
        if e_ - s_ > 0.2:
            print "victoria station update chunck ", e_ - s_  
        s_ = time.time()
        # Central
        ...
        e_ = time.time()
        if e_ - s_ > 0.2:
            print "central train update chunck ", e_ - s_
        s_ = time.time()
#         Victoria
        ...
        e_ = time.time()
        if e_ - s_ > 0.2:
            print "victoria train update chunck ", e_ - s_
...
#            print "save fifteen chunck ", time.time() - s_
#==============================================================================
#         if record_state : 
...
#    go15 = deepcopy(go15)
    # upadte train status
    for line_ in go15.monitors.keys(): # line ex. Central
        ...
        # update garages 
        for direction, garage in go15.monitors[line_].garages.iteritems():
...
#     # book keeping
# #==============================================================================
# #     god_story_15.append(god_of_fifteen)
# #     god_story_30.append(DS_god)
# #==============================================================================
